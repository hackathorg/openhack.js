(function() {
    ...
    function OrganiserSettingsController($scope, Global, OrganiserSettings, $stateParams) {
        $scope.global = Global;
        $scope.package = {
    ...
    OrganiserSettingsController.$inject = ['$scope', 'Global', 'OrganiserSettings', '$stateParams'];
